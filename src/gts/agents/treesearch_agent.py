...
class TreeSearchAgent(ABC, *components):
    ...
    def search(self, state: GameState):
        ...
        return self.get_best_move(), dict(self.search_info)
    ...
    @abstractmethod
    def should_backpropagate(self, node: TreeSearchNode, value) -> bool:
        """
    ...
    @abstractmethod
    def backpropagate(self, node: TreeSearchNode, value) -> None:
        """
